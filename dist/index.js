...
exports.makeAnalyticsClient = exports.NUM_TOP_PAGES = void 0;
  ...
  `;
    return function domains() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const data = yield gqlClient.request(query);
            return data.domains;
        });
    };
};
const makeFactsByDomainId = (gqlClient, domainId) => {
  ...
  `;
    ...
    return function facts() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const data = yield gqlClient.request(query, variables);
...
exports.NUM_TOP_PAGES = 10;
const makeAnalyticsClient = ({ endpoint, domainId, numTopPages = exports.NUM_TOP_PAGES, token }) => {
    if (isNaN(numTopPages)) {
        throw new Error(`numTopPages is not a number: ${numTopPages}`);
    }
    const gqlClient = new graphql_request_1.GraphQLClient(endpoint, {
        headers: {
...
exports.makeAnalyticsClient = makeAnalyticsClient;
...
const tslib_1 = __webpack_require__(4351);
const graphql_request_1 = __webpack_require__(2476);
const getBearerToken = ({ endpoint, username, password }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const query = graphql_request_1.gql `
...
const auth_1 = __webpack_require__(9725);
const analytics_1 = __webpack_require__(3415);
...
function run() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const numTopPages = Number(core.getInput('num_top_pages')) || analytics_1.NUM_TOP_PAGES;
            core.info(`${NAME} INPUT[num_top_pages] = ${numTopPages}`);
            core.debug(`${NAME} Authenticate with the Ackee GraphQL server`);
            const token = yield auth_1.getBearerToken({ endpoint, username, password });
            ...
            const analytics = analytics_1.makeAnalyticsClient({
                endpoint,
                domainId,
                numTopPages,
                token
            ...
            const domains = yield analytics.domains();
            const domainsFacts = yield analytics.domainsFacts();
            const events = yield analytics.events();
            const facts = yield analytics.facts();
            const topPages = yield analytics.topPages();
